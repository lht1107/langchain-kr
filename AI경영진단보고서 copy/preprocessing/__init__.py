...
This package includes functions for preprocessing company data, such as growth metrics,
profitability metrics, partner stability metrics, financial stability metrics, hr metrics, and cashflow metrics.
"""
